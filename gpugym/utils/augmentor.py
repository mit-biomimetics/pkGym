...
class Augmentor:
    def __init__(self, cfg):
        ...
        self.do_kin = cfg.env.obs_augmentations.add_kinematics_augmentations
        self.do_jac = cfg.env.obs_augmentations.add_jacobian_augmentations
        self.do_cen = cfg.env.obs_augmentations.add_centripetal_augmentations
        self.do_cor = cfg.env.obs_augmentations.add_coriolis_augmentations
        # self.base_pos_names = ['x', 'y', 'z',
        #                       'roll', 'pitch', 'yaw']
